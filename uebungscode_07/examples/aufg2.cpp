...
int main() {
    ...
    fmt::print("Alle Kanten, die existieren\n");
    sg.drucke();  // Drucken die Knoten mit der Verbindung
    
  // Breitensuche starten, z.B. vom Knoten 0
 std::vector<size_t> tiefensuche_resultat = sg.tiefensuche(0);

  // Das Ergebnis der Tiefensuche ausgeben
  fmt::print("Ergebnis von Tiefensuche von {0}\n", 0);
  fmt::print("{}\n", fmt::join(tiefensuche_resultat, " -> "));
